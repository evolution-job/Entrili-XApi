...
abstract class SerializerTest extends TestCase
{
    protected function buildSerializeTestCases($objectType)
    {
        ...
        $phpFixturesClass = 'Entrili\XApiBundle\Tests\Fixtures\Data\\' . $objectType . 'Fixtures';
        $jsonFixturesClass = 'Entrili\XApiBundle\Tests\Fixtures\Json\\' . $objectType . 'JsonFixtures';
