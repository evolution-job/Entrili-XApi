...
use Entrili\XApiBundle\Tests\Fixtures\Json\StatementJsonFixtures;
...
abstract class StatementSerializerTest extends SerializerTest
{
    ...
    public function testDeserializeStatement($json, Statement $expectedStatement)
    {
        ...
        $this->assertInstanceOf('Entrili\XApiBundle\Model\Statement', $statement);
    ...
    {
        /** @var \Entrili\XApiBundle\Model\Statement[] $statements */
